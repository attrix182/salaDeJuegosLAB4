...
@Component({
  selector: 'app-chat-mijuego',
  templateUrl: './chatMiJuego.component.html',
  styleUrls: ['./chatMiJuego.component.css']
})
export class ChatMiJuegoComponent implements AfterViewInit, OnInit{
  ...
  constructor(private router: Router, private MiServicio: ChatMiJuegoService, firestore: ChatMiJuegoService) {
